...
- **John Piper quotes** *(unverified)*: Two substantial quotes attributed to Piper: (1) about hearts knit together in love unlocking understanding, and (2) about encouragement and gratitude as guardians. These read like Piper but exact sources should be verified — likely from a sermon or blog post on Colossians 2. Check desiringgod.org.
- **Ann Voskamp quote** *(unverified)*: The eucharisteo/charis/chara etymology is from her book "One Thousand Gifts" (2010). Verify exact wording against the published text.
