...
- **Proverbs 27:17 allusion** *(wrong translation)*: Draft says "as iron sharpens iron so does one person sharpen another." ESV reads "Iron sharpens iron, and one man sharpens another." The "as…so" structure and "one person" are NIV renderings. Correct to ESV when polishing.
...
- **Romans 5:8** *(KJV wording, uncited)*: Draft says "while we were yet sinners, Christ died for us" without citing the reference. ESV reads "while we were **still** sinners" (not "yet"). "Yet" is KJV wording. Correct to ESV and add the citation when polishing.
