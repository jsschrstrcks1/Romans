...
- **David and Svea Flood story** *(verify details)*: This is a well-known missionary story, frequently retold. Key details to verify: (1) The timeline (~1920s, ~5 years in the village); (2) Baby's name (Aggie — full name Aggie Hurst née Flood); (3) The Ericksons and their fate; (4) The "110,000 people" national church figure; (5) David's death "a week later" after reconciliation. Various retellings differ on specific numbers and timing. The most authoritative source would be Aggie Hurst's own published accounts.
- **Toplady quote** *(unverified)*: "A man's free will cannot on its own even cure a toothache... yet madly thinks it is in his power to cure his soul." Widely attributed to Augustus Toplady (1740-1778, author of "Rock of Ages"). Verify against published works.
- **Spurgeon quote** *(unverified)*: "Free will has sent many men to hell, but never a man to heaven." Widely attributed to Charles Spurgeon. Verify against published sermons — likely from one of the Metropolitan Tabernacle Pulpit volumes.
- **Martin Luther quote** *(unverified)*: "We are compelled to serve the kingdom of satan until we be liberated" by God. Likely from "The Bondage of the Will" (De Servo Arbitrio, 1525). Verify exact wording.
- **Steven Lawson quote** *(unverified)*: "If you follow Christ you've given up dirt for diamonds." Attributed to Steven Lawson, contemporary Reformed preacher. Verify source — likely from a sermon or conference talk.
- **Sindhi Samas of Pakistan** *(unverified)*: People group statistics should be verified against current Joshua Project or IMB data before reuse.
- **Titanic illustration** *(noted)*: The story of the woman choosing oranges over diamonds. This is a widely circulated sermon illustration. Historical accuracy is uncertain — it may be apocryphal or based on a composite of survivor accounts. Flag if citing as historical fact.
