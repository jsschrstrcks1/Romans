...
```bash
python3 /home/user/.memory/memory_ops.py recall "" --scope /romans --limit 10
python3 /home/user/.memory/memory_ops.py tree /romans
```
...
```bash
python3 /home/user/.memory/memory_ops.py recall "QUERY" --scope /romans
```
...
```bash
python3 /home/user/.memory/memory_ops.py forget --scope /romans --older-than 90 --dry-run
python3 /home/user/.memory/memory_ops.py forget --scope /romans --older-than 90
```
