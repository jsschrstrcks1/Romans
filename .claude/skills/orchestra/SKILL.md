...
**Mode:** `sermon` (auto-detected from this repository)
**Domain:** sermon writing and theological study
...
```bash
cd /home/user/ken/orchestrator && python3 orchestra.py sermon "task description"
```
