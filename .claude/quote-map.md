...
*Full-text quote registry — every attributed quote with verification tier, provenance chain, and usage tracking.*

*Updated: March 21, 2026*

*All quotes extracted from sermon-map.md Subject columns. Verification status reflects what is documented in the sermon corpus.*
...
| Tier | Symbol | Meaning |
|------|--------|---------|
| Green | ✅ | Verified: exact wording confirmed against primary source |
| Yellow | ⚠️ | Partially verified: quote is real, exact source uncertain |
| Red | ❌ | Unverified or disputed: may be fabricated, misattributed, or conflated |
...
| # | Quote | Source | Verification | Used In | Count |
|---|-------|--------|-------------|---------|-------|
| 1 | Hearts as "sink of sin and spring of rebellion" | Attributed to Boston | ⚠️ Yellow — paraphrase, not exact wording | `Romans 4 - In Christ Alone.md` | 1 |
...
| # | Quote | Source | Verification | Used In | Count |
|---|-------|--------|-------------|---------|-------|
| 1 | On faith as mustard seed | Attributed to Charnock | ⚠️ Yellow — paraphrase | `Romans 4 - In Christ Alone.md` | 1 |
...
| # | Quote | Source | Verification | Used In | Count |
|---|-------|--------|-------------|---------|-------|
| 1 | "Sanctification flows from justification, not to it." | Stephen Davey (stated twice in sermon) | ⚠️ Yellow — attributed but no published source cited | `Romans 4 - In Christ Alone.md` | 1 |
...
| # | Quote | Source | Verification | Used In | Count |
|---|-------|--------|-------------|---------|-------|
| 1 | "If your god never disagrees with you, you might just be worshipping an idealized version of yourself." | Attributed to Keller | ⚠️ Yellow — exact wording unverified | Various | 1 |
...
| # | Quote | Source | Verification | Used In | Count |
|---|-------|--------|-------------|---------|-------|
| 1 | "Have You Left Your First Love?" | Desiring God, Apr 10, 2025 | ✅ Green — verified: DG article | `rev 2 1-7 forgotten first love.txt` | 1 |
...
| # | Quote | Source | Verification | Used In | Count |
|---|-------|--------|-------------|---------|-------|
| 1 | "At least 108 [OT prophecies] many of which He had no control over, if He were only a human being." | Sermon #2299, "Christ of the Old Testament," Love Worth Finding | ✅ Green — verified: sermon number and ministry confirmed | `Romans 1 - Psalm 22.md` | 1 |
...
| # | Quote | Source | Verification | Used In | Count |
|---|-------|--------|-------------|---------|-------|
| 1 | "Christ is never fully valued until sin is clearly seen." | Attributed to Ryle | ⚠️ Yellow — consistent with Ryle but exact source unconfirmed | Various | 1 |
| 2 | "Cheap Christianity" (concept/phrase) | Ryle | ⚠️ Yellow | Various | 1 |
...
- **Total unique quotes**: ~75
- **✅ Green (verified)**: 15
- **⚠️ Yellow (partially verified)**: ~55
- **❌ Red (unverified/disputed)**: 2
- **Most-quoted author**: Spurgeon (13 entries)
- **Most-reused quote**: Calvin's "factory of idols" (4 sermons)
- **Most frequently cited authors**: Spurgeon, Edwards, Owen, Calvin, MacArthur
