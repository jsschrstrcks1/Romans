...
*A tiered classification system for all doctrinal content in the sermon corpus. Each category maps to the theological-map.md entries and sermon-map.md file references. Use this to locate, classify, and cross-reference any theological topic across 200+ sermons.*

---

## How to Use This File

- **Tier 1** = Major locus (e.g., Theology Proper)
- **Tier 2** = Doctrine within that locus (e.g., Divine Attributes)
- **Tier 3** = Specific teaching (e.g., Immutability)
- **Strength** = How heavily the corpus treats this topic (Very Strong / Strong / Moderate / Light / Gap)
- **Key Files** = Primary sermon files where this doctrine is taught
- **Tradition** = Confessional/theological tradition the teaching aligns with
...
### 6.1 TULIP (Five Points of Calvinism)
| Tier 3 Topic | Strength | Key Files | Tradition |
|---|---|---|---|
...
### 7.1 Nature of the Church
| Tier 3 Topic | Strength | Key Files | Tradition |
|---|---|---|---|
| Body of Christ — Mutual Suffering | Very Strong | `1 Corinthians 12*.md` | Pauline, Baptist |
| Local Church — Not Optional | Very Strong | `1 Corinthians 12*.md` | 9Marks, Baptist |
| Regenerate Church Membership | Strong | `Acts 18 1 Cor 3*.md` | Baptist |
| Consumer Christianity Rejected | Strong | `1 Corinthians 12*.md` | 9Marks-adjacent |

### 7.2 Ordinances
| Tier 3 Topic | Strength | Key Files | Tradition |
|---|---|---|---|
| Believer's Baptism (Immersion) | Strong | `Romans 6.md`, `Acts 18 1 Cor 3*.md` | Baptist |
| Lord's Supper (Memorial) | Moderate | Communion references across corpus | Baptist |
...
## 8. Bibliology (Doctrine of Scripture)
...
## 10. Missiology (Doctrine of Mission)
...
## 11. Ethics and Christian Life

### 11.1 Sanctification in Practice
| Tier 3 Topic | Strength | Key Files | Tradition |
|---|---|---|---|
...
## 13. Counterfeit Religions and Apologetics
...
## 14. Confessional Anchors

The corpus operates under these confessional standards:
...
Topics with minimal or no dedicated treatment in the corpus. Cross-reference with `preaching-gap-analysis.md` for full detail.

| Gap Area | Notes |
|---|---|
| Systematic Theology of Prayer | Covered in context (Nehemiah, Colossians) but no standalone treatment of prayer's basis, mechanics, unanswered prayer |
| Lament Psalms (42-43, 88) | Psalm 42 has a sermon; 43 and 88 untouched |
| Phil 2:5-11 (Kenosis Hymn) | Referenced but no dedicated exposition |
| Psalm 22 (Passion Psalm) | Raw draft only; never the primary preaching text |
| Angelology / Demonology | Minimal; Satan referenced pastorally but no systematic treatment |
| Doctrine of Vocation / Work | Implicit but no dedicated sermon |
| Biblical Theology of Suffering (Systematic) | Strong individual treatments but no unified series |
| Covenantal Framework (Systematic) | Elements present throughout but no dedicated covenant theology series |

---

*Generated from the full sermon corpus. Cross-reference theological-map.md for quote-level sourcing and sermon-map.md for complete file inventory.*
