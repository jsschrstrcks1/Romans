...
| `galatians 1.md` | *(flags added March 2026)* ⚠️ Luther insult quotes at end of file — may be from Luther insult generators rather than authentic primary sources; verify before attributing to Luther in print or preaching |
| `gal 2.md` | *(flags added March 2026)* ⚠️ "Romans 3 vs 3" — content is Rom 3:5, not 3:3; ⚠️ "Paul quotes [Isa 64] in Romans 3:10" — incorrect; Rom 3:10 quotes Ps 14/53, not Isa 64:6; ⚠️ Calvin "factory of idols" quote — unattributed in sermon; attribute to *Institutes* 1.11.8 or remove |
