...
- Romans 1 - Psalm 22 raw draft: Rogers "108" corrected to "more than 300" ✓ (March 2026); Torrey book title added as *The Bible and Its Christ* (1906) ✓ — count still needs text verification ⚠️
...
| `Psalm 8 - Hebrews 2 (raw draft).md` | ~~4 flags~~ → **3 flags remain** *(reviewed March 2026)*: ~~"in the Greek"~~ ✓ corrected to Hebrew; ~~Deut 32:9~~ ✓; ~~Caño Cristales volcano~~ ✓ removed; ~~Isa 64:6~~ ✓ ESV; ~~Looe Key~~ ✓; ~~"How He Loves"~~ ✓ McMillan; ~~Ryle quote~~ ✓ *Holiness* p.204. Remaining: ⚠️ Platt / Muslim cab story — no indexed source; ⚠️ Edwards "sin that made salvation necessary" — not in Yale critical edition, softened to "often attributed to"; ⚠️ MacArthur Romans 6 — reworded as paraphrase |
| `Psalm 119 161-168 (raw draft).md` | ~~10 flags~~ → **2 flags remain** *(reviewed March 2026)*: ~~Fenn helicopter~~ ✓; ~~Fenn poem clues~~ ✓; ~~Fenn deaths~~ ✓; ~~Fenn "Midwest"~~ ✓; ~~US population~~ ✓; ~~Brother Andrew prayer wording~~ ✓ corrected "in my car" → "in my luggage" (verified via Open Doors SA / Trail Life USA / Open Doors UK); ~~Brother Andrew destination~~ ✓ corrected "Romania" → "Yugoslavia" (same sources — first use of prayer was Yugoslavia 1957; Romania is a distinct anecdote). Remaining: ⚠️ Florida opiates "more than rest of country combined" — verify source/currency; ⚠️ Florida Xanax — same |
...
| `Romans 1 - Psalm 22 (Prophecy raw draft).md` | ~~8 flags~~ → **2 flags remain** *(reviewed March 2026)*: ~~Ps 22:17 "bones not broken"~~ ✓; ~~Rom 10:9~~ ✓; ~~Deut 18:20-22~~ ✓; ~~table reformatted~~ ✓; ~~Rogers "108"~~ ✓ corrected to "more than 300" (LWF sermons); ~~Torrey book title~~ ✓ now *The Bible and Its Christ* (1906). Remaining: ⚠️ "68% accuracy" stat — no source; ⚠️ Torrey count of 300 — book title confirmed but count needs direct text verification; ⚠️ 10 fulfillment citations not individually ESV-checked |
| `Romans 3 - antinomianism draft.md` | ~~3 flags~~ → **1 flag remains** *(reviewed March 2026)*: ~~false statutes removed~~ ✓; ~~Noushad case corrected~~ ✓; ~~verse citations corrected~~ ✓. Remaining: ⚠️ John Brown quote — pending verification against Archive.org digitized copy |
| `Proverbs 13 (raw draft).md` | ~~"Multiple flags"~~ → **1 flag remains** *(reviewed March 2026)*: ~~"700% decline"~~ ✓ corrected; ~~"3-7 hrs screens"~~ ✓ updated to Common Sense Media data; ~~"3 hrs Puritan Scripture"~~ ✓ reframed; ~~Edwin Starr/Lockheed~~ ✓ cut entirely; ~~Newton/round earth~~ ✓ reframed; ~~"spare the rod"~~ ✓ ESV. Remaining: ⬜ pew Bible page number (pastor fills in) |
