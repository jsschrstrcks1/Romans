...
- Romans 1 - Psalm 22 raw draft: Rogers "108" → "more than 300" ✓; Torrey "cataloged 300" claim corrected — Torrey never enumerates a count; "cataloged" removed; body now says he "argued from fulfilled OT prophecy" ✓ (March 2026). 1 flag remains: "68% accuracy" stat needs source.
...
| `Psalm 119 161-168 (raw draft).md` | ~~10 flags~~ → **0 flags remain** *(reviewed March 2026)*: ~~Fenn helicopter~~ ✓; ~~Fenn poem clues~~ ✓; ~~Fenn deaths~~ ✓; ~~Fenn "Midwest"~~ ✓; ~~US population~~ ✓; ~~Brother Andrew prayer wording~~ ✓; ~~Brother Andrew destination~~ ✓ Romania → Yugoslavia; ~~Florida opiates~~ ✓ pastor-certified (primary source not documented — add before publication); ~~Florida Xanax~~ ✓ same. **All flags resolved.** |
...
| `Romans 1 - Psalm 22 (Prophecy raw draft).md` | ~~8 flags~~ → **1 flag remains** *(reviewed March 2026)*: ~~Ps 22:17 "bones not broken"~~ ✓; ~~Rom 10:9~~ ✓; ~~Deut 18:20-22~~ ✓; ~~table reformatted~~ ✓; ~~Rogers "108"~~ ✓ → "more than 300"; ~~Torrey "cataloged 300"~~ ✓ → corrected: Torrey never enumerates a count; "cataloged" removed; body now says he "argued from fulfilled OT prophecy" citing *The Bible and Its Christ* (1906). Remaining: ⚠️ "68% accuracy" stat for modern prophets — no source; ⚠️ 10 fulfillment citations not individually ESV-checked |
