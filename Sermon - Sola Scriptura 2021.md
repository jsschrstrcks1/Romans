...
- **"Trevor Noah" attribution — MISATTRIBUTION (March 2026)**: The quote is attributed to "a man named Trevor Noah." The prominent person named Trevor Noah (b. 1984) is a South African-American comedian and former host of *The Daily Show*. The vocabulary ("evangelicalism," "supersede scripture's authority") and register of this quote are academic evangelical theological commentary entirely inconsistent with Trevor Noah's public writing. Research (March 2026) failed to locate this quote in any indexed source under Trevor Noah's name. The most plausible explanation is a phonetic misattribution: the name most consistent with both the sound ("Trev-") and the content is **Trevin Wax** (evangelical author, editor at LifeWay Christian Resources, contributor to *The Gospel Coalition*), who writes extensively on Scripture's authority in contemporary evangelicalism. **Albert Mohler** (president of Southern Baptist Theological Seminary) is a secondary candidate. However, the quote could not be confirmed verbatim under either name. **Do not use this quote in any form until the original source is identified and verified.** If the original speaker cannot be found, the quote should be retired.
...
- **Four Luther quotes — unverified to primary source (March 2026)**: All four attributed Luther quotes lack primary source citation. Research (March 2026) found all four quotes appearing in **Bob Kellemen, *Counseling Under the Cross* (New Growth Press, 2017)**, which itself cites Luther's Works (American Edition) with footnote references. The Kellemen book is therefore the most likely proximate source for all four quotes as used here. However, the primary Luther's Works citations from Kellemen were not confirmed against the original volumes in this session. Before preaching, verify each quote against *Luther's Works* (Concordia/Fortress, 55 vols.) using Kellemen's footnotes as a starting point; alternatively, the Weimarer Ausgabe (WA) may be used. All four are theologically consistent with Luther's documented positions on Scripture and spiritual warfare.
  - Quote 1: "You have the Apostle Paul who shows to you a garden..." (cites Romans 15:4 internally ✓) — likely from Luther's sermons or *Table Talk*
...
- **David/Goliath interpolation in Luther Quote 3** *(confirmed — March 2026)*: The sentence "Such an endeavor would be worse than David against Goliath — without God's supernatural power helping David" is the preacher's own commentary, not part of the Luther quote. This is confirmed by the Kellemen source: the surrounding Luther material does not include this sentence. Clearly separate this in delivery and in any printed/distributed form.
